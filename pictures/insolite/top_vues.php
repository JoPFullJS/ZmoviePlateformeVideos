...
<!-- END ExoClick.com Ad Code -->
   ...
   <!-- contenu -->
	...
	<div class="float_nav">
		...
		<div class="titre_categorie"><h4 style="margin-top:0px; margin-bottom:0px;"><span style="text-transform : capitalize;"><?php echo $verif_meta['theme']; ?></span><span> : Les plus consultés</span></h4></div>
...
{
	echo '<li class="page_number_nav float_left"><a href=http://www.divertiz.com/pictures/'.$catego.'/top_vues.php?page=1>Debut&nbsp;</a></li>';
}
...
{
	echo '<li class="page_number_nav float_left" style="margin-right:5px;"><a href=http://www.divertiz.com/pictures/'.$catego.'/top_vues.php?page='.$prev.'>Prec.&nbsp;</a></li>';
}
/////////////////////////////////
if($ID_courant >= $nb_page-2)
{
  if($fin>0)
  {
	...
	{
	  echo '<li class="page_number float_left"><a href=http://www.divertiz.com/pictures/'.$catego.'/top_vues.php?page='.$page_m.'>'.$page_m.'</a></li>';
	}
  }
  else
  {
...
if($ID_courant <=3)
{
  if($debut<$nb_page)
  {
	for($page_p=$ID_courant+1;$page_p<=$debut;$page_p++)
	{
	  ...
	  echo '<li class="page_number float_left"><a href=http://www.divertiz.com/pictures/'.$catego.'/top_vues.php?page='.$page_p.'>'.$page_p.'</a></li>';
	}
  }
  else
  {
...
{
	echo '<li class="page_number_nav float_left" style="margin-left:5px;"><a href=http://www.divertiz.com/pictures/'.$catego.'/top_vues.php?page='.$suiv.'>Suiv.&nbsp;</a></li>';
}
...
{
	echo '<li class="page_number_nav float_left"><a href=http://www.divertiz.com/pictures/'.$catego.'/top_vues.php?page='.$nb_page.'>Fin&nbsp;</a></li>';
}
?>
</ul>
</div>
