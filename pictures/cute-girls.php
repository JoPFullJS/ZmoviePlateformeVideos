...
<meta name="keywords" content="<?php if(isset($verif_meta['keyword'])) echo $verif_meta['keyword']; else echo "animaux"; ?>" />
<meta name="description" lang="fr" content="<?php if(isset($verif_meta['description'])) echo $verif_meta['description']; else echo "Videoscaster.com"; ?>" />
...
<title><?php if(isset($verif_meta['description'])) echo $verif_meta['description']; else echo "Videoscaster.com"; ?></title>
