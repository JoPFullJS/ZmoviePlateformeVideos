...
//categorie
	...
	$base=substr($cat,$chaine2,$chaine);
   ...
   define('DB_NAME', 'onecaste_game');   define('DB_USER', 'onecaste_media');
...
<link rel="canonical" href="http://www.divertiz.com/games/<?php echo $base; ?>/top_vues.php" />
  ...
  <!-- Moteur de recherche-->
   ...
   <div class="fd_ss_cat">
			<ul class="pos_ss">
				...
				<li class="puce_ss" onmouseover="showMenu(this);" onmouseout="hideMenu(this);">
					<a class="lk_ss" href="http://www.divertiz.com/index.php">Categories</a>
				...
				<li class="puce_ss" onmouseover="showMenu(this);" onmouseout="hideMenu(this);">
				<a class="lk_ss puce" href="http://www.divertiz.com/games/All_games.php">Games</a>
				<div class="menu_down">
				<div class="menu_game">
...
<!-- END ExoClick.com Ad Code -->
   ...
   <!-- contenu -->
	...
	<div class="float_nav">
			...
			<span><a class="txt_li_nav" href="http://www.divertiz.com/games/All_games.php">games</a></span>
			<span class="txt_nav"> &rsaquo; </span>
			<span><a class="txt_li_pos" href="http://www.divertiz.com/games/<?php echo $verif_meta['theme']; ?>/top_votes.php"><?php echo $verif_meta['theme']; ?></a></span>
	</div>
		<div class="titre_categorie"><h4 style="margin-top:0px; margin-bottom:0px;"><span style="text-transform : capitalize;"><?php if(isset($verif_meta['theme'])) echo $verif_meta['theme']; ?></span><span> : Les plus consultés</span></h4></div>
		<div  class="red_line"></div>
		<div class="pertinance">
		 <ul class="pertinancepos">
		<li class="cast_pert"><a class="connectpert lkpert" href="../<?php if(isset($verif_meta['theme'])) echo $verif_meta['theme']; ?>.php">New videos</a></li>
		...
		<div class="info_pertinace">Pertinance : <span style="color:rgb(192,8,13); letter-spacing:1px;">Les plus consultés</span><span></span></div>
...
{
	echo '<li class="page_number_nav float_left"><a href=http://www.divertiz.com/games/'.$catego.'/top_vues.php?page=1>Debut&nbsp;</a></li>';
}
...
{
	echo '<li class="page_number_nav float_left" style="margin-right:5px;"><a href=http://www.divertiz.com/games/'.$catego.'/top_vues.php?page='.$prev.'>Prec.&nbsp;</a></li>';
}
/////////////////////////////////
if($ID_courant >= $nb_page-2)
{
  if($fin>0)
  {
	...
	{
	  echo '<li class="page_number float_left"><a href=http://www.divertiz.com/games/'.$catego.'/top_vues.php?page='.$page_m.'>'.$page_m.'</a></li>';
	}
  }
  else
  {
...
if($ID_courant <=3)
{
  if($debut<$nb_page)
  {
	for($page_p=$ID_courant+1;$page_p<=$debut;$page_p++)
	{
	  ...
	  echo '<li class="page_number float_left"><a href=http://www.divertiz.com/games/'.$catego.'/top_vues.php?page='.$page_p.'>'.$page_p.'</a></li>';
	}
  }
  else
  {
...
{
	echo '<li class="page_number_nav float_left" style="margin-left:5px;"><a href=http://www.divertiz.com/games/'.$catego.'/top_vues.php?page='.$suiv.'>Suiv.&nbsp;</a></li>';
}
...
{
	echo '<li class="page_number_nav float_left"><a href=http://www.divertiz.com/games/'.$catego.'/top_vues.php?page='.$nb_page.'>Fin&nbsp;</a></li>';
}
?>
</ul>
</div>
