...
<!-- END ExoClick.com Ad Code -->
   ...
   <!-- contenu -->
	...
	<div class="float_nav">
			...
			<span class="txt_nav"> &rsaquo; </span>
			<span><a class="txt_li_pos" href="top_vues.php">top vues</a></span>
	</div>
		<div class="titre_categorie"><h4 style="margin-top:0px; margin-bottom:0px;">Les plus consultés</h4></div>
		...
		<div class="info_pertinace">Pertinance : <span style="color:rgb(192,8,13);">Les plus consultés</span><span></span></div>
