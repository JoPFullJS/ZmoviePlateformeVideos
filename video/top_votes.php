...
<!-- END ExoClick.com Ad Code -->
   ...
   <!-- contenu -->
	...
	<div class="float_nav">
			...
			<span><a class="txt_li_nav" href="../index.php">videos rent</a></span>
			<span class="txt_nav"> &rsaquo; </span>
			<span><a class="txt_li_pos" href="top_vues.php">top votes</a></span>

			
	</div>
		<div class="titre_categorie"><h4 style="margin-top:0px; margin-bottom:0px;"><span style="text-transform : capitalize;">Toutes les videos</span><span> : Meilleurs classement</span></h4></div>
