...
<!-- END ExoClick.com Ad Code -->
   ...
   <!-- contenu -->
	...
	<div class="float_nav">
		...
		<div class="titre_categorie"><h4 style="margin-top:0px; margin-bottom:0px;"><span style="text-transform : capitalize;">Toutes les videos</span><span> : Les plus consultés</span></h4></div>
