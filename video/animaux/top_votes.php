...
<link rel="canonical" href="http://www.divertiz.com/video/<?php echo $verif_meta['theme']; ?>/top_votes.php" />
...
<!-- END ExoClick.com Ad Code -->
   ...
   <!-- contenu -->
	...
	<div class="float_nav">
			...
			<span class="txt_nav"> &rsaquo; </span>
			<span><a class="txt_li_pos" href="http://www.divertiz.com/video/<?php echo $verif_meta['theme']; ?>/top_votes.php"><?php echo $verif_meta['theme']; ?></a></span>
		...
		<div class="info_pertinace">Pertinance : <span style="color:rgb(192,8,13); letter-spacing:1px;">Meilleurs classement</span></div>
...
{
	echo '<li class="page_number_nav float_left"><a href=http://www.divertiz.com/video/'.$verif_meta['theme'].'/top_votes.php?page=1>Debut&nbsp;</a></li>';
}
...
{
	echo '<li class="page_number_nav float_left" style="margin-right:5px;"><a href=http://www.divertiz.com/video/'.$verif_meta['theme'].'/top_votes.php?page='.$prev.'>Prec.&nbsp;</a></li>';
}
/////////////////////////////////
if($ID_courant >= $nb_page-2)
{
  if($fin>0)
  {
	...
	{
	  echo '<li class="page_number float_left"><a href=http://www.divertiz.com/video/'.$verif_meta['theme'].'/top_votes.php?page='.$page_m.'>'.$page_m.'</a></li>';
	}
  }
  else
  {
...
if($ID_courant <=3)
{
  if($debut<$nb_page)
  {
	for($page_p=$ID_courant+1;$page_p<=$debut;$page_p++)
	{
	  ...
	  echo '<li class="page_number float_left"><a href=http://www.divertiz.com/video/'.$verif_meta['theme'].'/top_votes.php?page='.$page_p.'>'.$page_p.'</a></li>';
	}
  }
  else
  {
...
{
	echo '<li class="page_number_nav float_left" style="margin-left:5px;"><a href=http://www.divertiz.com/video/'.$verif_meta['theme'].'/top_votes.php?page='.$suiv.'>Suiv.&nbsp;</a></li>';
}
...
{
	echo '<li class="page_number_nav float_left"><a href=http://www.divertiz.com/video/'.$verif_meta['theme'].'/top_votes.php?page='.$nb_page.'>Fin&nbsp;</a></li>';
}
?>
</ul>
</div>
