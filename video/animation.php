...
if(isset($_SESSION['user']))
{
   ...
   $req_meta = $pdo->query($select_meta);
...
<link rel="canonical" href="../video/<?php echo $base; ?>.php" />
  ...
  <!-- Moteur de recherche-->
   ...
   <!-- contenu -->
	...
	<div class="float_nav">
			...
			<span class="txt_nav"> &rsaquo; </span>
			<span><a class="txt_li_pos" href="http://www.divertiz.com/video/<?php echo $verif_meta['theme']; ?>.php"><?php echo $verif_meta['theme']; ?></a></span>
	</div>
		<div class="titre_categorie"><h4 style="margin-top:0px; margin-bottom:0px;"><span style="text-transform : capitalize;"><?php echo $verif_meta['theme']; ?></span></h4></div>
		...
		<div class="info_pertinace">Pertinance : <span style="color:rgb(192,8,13); letter-spacing:1px;">New videos</span></div>
...
{
	echo '<li class="page_number_nav float_left"><a href=http://www.divertiz.com/video/'.$base.'.php?page=1>Debut&nbsp;</a></li>';
}
...
{
	echo '<li class="page_number_nav float_left" style="margin-right:5px;"><a href=http://www.divertiz.com/video/'.$base.'.php?page='.$prev.'>Prec.&nbsp;</a></li>';
}
/////////////////////////////////
if($ID_courant >= $nb_page-2)
{
  if($fin>0)
  {
	...
	{
	  echo '<li class="page_number float_left"><a href=http://www.divertiz.com/video/'.$base.'.php?page='.$page_m.'>'.$page_m.'</a></li>';
	}
  }
  else
  {
...
if($ID_courant <=3)
{
  if($debut<$nb_page)
  {
	for($page_p=$ID_courant+1;$page_p<=$debut;$page_p++)
	{
	  ...
	  echo '<li class="page_number float_left"><a href=http://www.divertiz.com/video/'.$base.'.php?page='.$page_p.'>'.$page_p.'</a></li>';
	}
  }
  else
  {
...
{
	echo '<li class="page_number_nav float_left" style="margin-left:5px;"><a href=http://www.divertiz.com/video/'.$base.'.php?page='.$suiv.'>Suiv.&nbsp;</a></li>';
}
...
{
	echo '<li class="page_number_nav float_left"><a href=http://www.divertiz.com/video/'.$base.'.php?page='.$nb_page.'>Fin&nbsp;</a></li>';
}
?>
</ul>
</div>
	  ...
	  <div class="grunge_footer">
			...
			<div class="float_copyright">
				...
				<ul class="block_media">
					<li class=""><a class="" href="http://www.divertiz.com/"><img src="../img/img_main/divertiz.png" width="150" /></a></li>
					<li class=""><span> &copy; - divertiz.com 2015-2016</span></li>
				</ul>
			</div>
			...
			<ul class="block_legal">
					<li class=""><a class="" href="http://www.gazzling.com/"><img src="../img/img_main/logo_in.png" width="150" /></a></li>
				</ul>
			</div>
