...
if(isset($_SESSION['user']))
{
   ...
   $video_select = "SELECT a.ID_element,a.ID,a.ID_categorie,a.titre,a.description,a.ID_data,a.date,a.keyword,b.lk_image,b.lk_fichier,b.embed_game,b.lk_origine,c.id_stat,c.nb_vue,d.ID_compteur,d.vt_pos,d.vt_neg FROM descriptions AS a,lien AS b,statistiques AS c,compteur AS d WHERE a.ID_element=b.ID_lien AND a.ID_element=c.id_stat AND a.ID_element=d.ID_compteur AND a.ID_element IN ('".$id."')";
...
<!-- END ExoClick.com Ad Code -->
   ...
   <!-- contenu -->
	...
	<div class="float_nav">
			...
			<span class="txt_nav"> &rsaquo; </span>
			<span><a class="txt_li_pos" href="http://www.divertiz.com/games/<?php echo $catego; ?>.php"><?php echo $catego; ?></a></span>
	</div>
		...
		<div style="height:5px;"></div>
			<div class="video_embled" style="margin-left:auto; margin-right:auto; width:650px;" >
					...
					<br /><a href="<?php echo $verif_video['lk_origine']; ?>"><?php echo $verif_video['titre']; ?></a>
			</div>
