...
if(isset($_SESSION['user']))
{
   ...
   $keyword=explode(',',$mot);
	...
	$select_similaire = "SELECT a.ID_element,a.ID_categorie,a.ID_data,a.titre,a.date,a.keyword,b.ID_lien,b.lk_image,b.lk_fichier,c.id_stat,c.nb_vue,d.ID_compteur,d.vt_pos,d.vt_neg,e.ID,e.theme FROM descriptions AS a,lien AS b,statistiques AS c,compteur AS d,categories AS e WHERE a.ID_element=b.ID_lien AND a.ID_element=c.id_stat AND a.ID_element=d.ID_compteur AND e.ID=a.ID_categorie AND (".$req_search.") AND a.ID_element NOT IN ('".$id."') LIMIT 6";
   ...
   $video_select = "SELECT a.ID_element,a.ID,a.ID_categorie,a.titre,a.description,a.largeur,a.ID_data,a.date,a.keyword,b.lk_image,b.lk_fichier,b.lk_origine,c.id_stat,c.nb_vue,d.ID_compteur,d.vt_pos,d.vt_neg FROM descriptions AS a,lien AS b,statistiques AS c,compteur AS d WHERE a.ID_element=b.ID_lien AND a.ID_element=c.id_stat AND a.ID_element=d.ID_compteur AND ID_element IN ('".$id."')";
...
<meta property="og:description"  content="<?php $description=strip_tags($verif_video['description']); echo $description;  ?>"/>
...
<meta name="description" lang="fr" content="<?php $description=strip_tags($verif_video['description']); echo $description;  ?>" />
...
<body onload="videorandom(<?php echo $verif_video['ID_data']; ?>);">
				...
				<div class="menu_game">
					...
					<div class="Game_one">
					  <ul class="float_gamer">
						...
						<li class="left_top_annu"><a class="cat_video_sx" href="http://www.divertiz.com/games/top_votes.php">Mieux not�e</a></li>
					...
					<div class="Game_two">
					<ul class="float_gamer">
						<li class="left_top_annu"><a class="cat_video_sx" href="http://www.divertiz.com/games/strategie.php">Strat�gie</a></li>
...
<!-- END ExoClick.com Ad Code -->
   ...
   <!-- contenu -->
	...
	<div class="float_nav">
			...
			<span><a class="txt_li_nav" href="http://www.divertiz.com/pictures/All_pictures.php">image</a></span>
			<span class="txt_nav"> &rsaquo; </span>
			<span><a class="txt_li_pos" href="http://www.divertiz.com/pictures/<?php echo $catego; ?>.php"><?php echo $catego; ?></a></span>
	</div>
...
<div style="margin-left:auto; margin-right:auto; width:<?php echo $verif_video['largeur']; ?>px;" >
			<img src="<?php echo $verif_video['lk_origine']; ?>" />
			</div>
		...
		<div class="fb-like" data-href="<?php echo $verif_video['lk_fichier']; ?>" data-send="false" data-layout="button_count" data-width="250" data-show-faces="false" data-font="arial"></div>
			...
			<span><strong>Post� le :  </strong> <?php
   ...
   ?>
		 ...
		 <?php while($verif_similaire = mysql_fetch_array($req_similaire)) { ?>
			 ...
			 <div class="date_upload">
				...
				<div class="img_container">
					...
					<a class="titre_container" href="<?php echo $verif_similaire['lk_fichier']; ?>" ><?php echo htmlentities($verif_similaire['titre']); ?></a>
				</div>
					<div class="stat_video">
					    <div class="img_categorie txt_info ">
							<span class="display black"><?php echo $verif_similaire['theme']; ?></span>
							<span class="capitale display">cat.</span>
						</div>
						<div class="img_vues txt_info ">
							<span class="display black"><?php echo number_format($verif_similaire['nb_vue'],0,',',','); ?></span>
	...
	<div class="like_reseau_sociaux">
	    ...
	    <div class="prec_suiv">
				...
				<a class="display_block" href="<?php echo $verif_cat_pre['lk_fichier']; ?>">Pr�c�dent</a>
				</div>
	   ...
	   ?>
		...
		<div class="prec_suiv">
				...
				<a class="display_block" href="<?php echo $verif_pre['lk_fichier']; ?>">Pr�c�dent</a>
				</div>
		...
		<!-- Listing cat�gorie pour videos -->
		<div class="titre_annexe">
		<h3 class="dis_titre">IMAGES AU HASARD</h3>
		</div>
		<!--id="charger" -->
...
<div class="statslive"><!-- http://livestats.fr - Outils de mesure d'audience en temps r�el -->
