<?php
 ...
 if(isset($_GET['q']) && $_GET['db'] == 1)
 {
   ...
   $count_cat = "SELECT COUNT(DISTINCT ID_element) AS id FROM descriptions WHERE keyword LIKE '%".$_GET['q']."%'";
   ...
   $cat_select = "SELECT a.ID_element,a.ID_data,a.titre,a.duree,a.date,b.ID_lien,b.lk_image,b.lk_fichier,c.id_stat,c.nb_vue,d.ID_compteur,d.vt_pos,d.vt_neg FROM descriptions AS a,lien AS b,statistiques AS c,compteur AS d WHERE a.ID_element=b.ID_lien AND a.ID_element=c.id_stat AND a.ID_element=d.ID_compteur AND a.keyword LIKE '%".$_GET['q']."%' ORDER BY ((d.vt_pos*100)/(d.vt_pos+d.vt_neg)) DESC LIMIT ".$lim_bas.",".$lim_haut."";
   //On traite la requete de la categorie
   $req_select = mysql_query($cat_select,$rent_bd);
 }
 else if(isset($_GET['q']) && $_GET['db'] == 2)
 {
   ...
   //On selectionne les element de la categorie
   $cat_select = "SELECT a.ID_element,a.ID_categorie,a.ID_data,a.titre,a.date,b.ID_lien,b.lk_image,b.lk_fichier,c.id_stat,c.nb_vue,d.ID_compteur,d.vt_pos,d.vt_neg,e.ID,e.theme FROM descriptions AS a,lien AS b,statistiques AS c,compteur AS d,categories AS e WHERE a.ID_element=b.ID_lien AND a.ID_element=c.id_stat AND a.ID_element=d.ID_compteur AND a.ID_categorie=e.ID AND a.keyword LIKE '%".$_GET['q']."%' ORDER BY ((d.vt_pos*100)/(d.vt_pos+d.vt_neg)) DESC LIMIT ".$lim_bas.",".$lim_haut."";
   //On traite la requete de la categorie
   $req_select = mysql_query($cat_select,$rent_bd);
 }
 else if(isset($_GET['q']) && $_GET['db'] == 3)
 {
...
<!-- END ExoClick.com Ad Code -->
   ...
   <!-- contenu -->
	...
	<div class="float_nav">
			...
			<span><a class="txt_li_nav" href="http://www.gazzling.com/index.php">accueil</a></span>
			<span class="txt_nav"> &rsaquo; </span>
			<span><a class="txt_li_pos" href="http://www.gazzling.com/index.php">recherche</a></span>
			
	</div>
		<div class="titre_categorie"><h4 style="margin-top:0px; margin-bottom:0px;"><span style="text-transform : capitalize;">Recherche pour:<?php echo $_GET['q']; ?></span></h4></div>
			...
			<?php while($verif_select = mysql_fetch_array($req_select)) { ?>
			 ...
			 <div class="date_upload">
				...
				<div class="img_container">
					...
					<?php } else if($_GET['db'] == 2 || $_GET['db'] == 3) { ?>
...
{
	echo '<li class="page_number_nav float_left"><a href=http://www.divertiz.com/shared/search.php?page=1&db='.$_GET['db'].'&q='.$_GET['q'].'>Debut&nbsp;</a></li>';
}
...
{
	echo '<li class="page_number_nav float_left" style="margin-right:5px;"><a href=http://www.divertiz.com/shared/search.php?page='.$prev.'&db='.$_GET['db'].'&q='.$_GET['q'].'>Prec.&nbsp;</a></li>';
}
/////////////////////////////////
if($ID_courant >= $nb_page-2)
{
  if($fin>0)
  {
	...
	{
	  echo '<li class="page_number float_left"><a href=http://www.divertiz.com/shared/search.php?page='.$page_m.'&db='.$_GET['db'].'&q='.$_GET['q'].'>'.$page_m.'</a></li>';
	}
  }
  else
  {
...
if($ID_courant <=3)
{
  if($debut<$nb_page)
  {
	for($page_p=$ID_courant+1;$page_p<=$debut;$page_p++)
	{
	  ...
	  echo '<li class="page_number float_left"><a href=http://www.divertiz.com/shared/search.php?page='.$page_p.'&db='.$_GET['db'].'&q='.$_GET['q'].'>'.$page_p.'</a></li>';
	}
  }
  else
  {
...
{
	echo '<li class="page_number_nav float_left" style="margin-left:5px;"><a href=http://www.divertiz.com/shared/search.php?page='.$suiv.'&db='.$_GET['db'].'&q='.$_GET['q'].'>Suiv.&nbsp;</a></li>';
}
...
{
	echo '<li class="page_number_nav float_left"><a href=http://www.divertiz.com/shared/search.php?page='.$nb_page.'&db='.$_GET['db'].'&q='.$_GET['q'].'>Fin&nbsp;</a></li>';
}
?>
</ul>
</div>
